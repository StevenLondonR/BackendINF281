...
public interface NuestraOrgRepository extends JpaRepository<NuestraOrganizacion,Integer>{
    ...
    @Modifying
    @Query("UPDATE NuestraOrganizacion d SET d.mision = COALESCE(:mision, d.mision) , d.vision = COALESCE(:vision, d.vision) , d.quehacemos = COALESCE( :quehacemos, d.quehacemos) WHERE d.idorganizacion = :id_organizacion")
