...
public interface UsuarioRepository extends JpaRepository<Usuario,Integer>{
    ...
    @Modifying  
    @Query("SELECT new Backend.BackendINF281.Mensajes.Controller.UsuarioPostResponse(u.idUsuario, u.nombre, u.apellido, u.correo, u.telefono, u.estado) FROM Usuario u WHERE u.estado = 'Pendiente' OR u.estado = 'Rechazado' OR u.estado = 'Inabilitado' ")   
